...
document.addEventListener("DOMContentLoaded", function () {
    // Your existing code for generating random colors goes here
  
    // Get the copy button and add a click event listener
    var copyButton = document.getElementById("copyColor");
    copyButton.addEventListener("click", function () {
      ...
      // Optionally, provide some visual feedback or alert
